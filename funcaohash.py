...
frases = ["A primeira das instituições criadas pelo Pe. Roberto Sabóia de Medeiros foi a antiga Escola Superior de Administração de Negócios de São Paulo - ESAN/SP.",
...
hashSHA256 = ["d24de3ec3835115c576a55188a31761b73af93ed2c45a171c810bb66b24b08f9",
...
hashMD5 = ["c850e1a34a6ed572e0758ccd9c615bda",
...
i = 0
print("Frases em SHA256")
for frase in frases:
    SHA256 = hashlib.sha256(frase.encode('utf-8')).hexdigest()
    print("Verdadeiro" if SHA256 == hashSHA256[i] else "Falso")
    i += 1
...
for frase in frases:
    ...
    print("Verdadeiro" if MD5 == hashMD5[i] else "Falso")
    i += 1